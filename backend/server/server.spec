...
datas += [(api_path, 'api'), (server_path, 'server'), (spec_root+'/updates', 'updates'), (spec_root+'/tufup_root', 'tufup_root'), (spec_root + '/staticfiles', 'staticfiles'), (spec_root + '/static', 'static'), (spec_root + '/templates', 'templates')]
